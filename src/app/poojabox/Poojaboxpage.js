...
export default function Poojaboxpage() {
  ...
  const sorting = async (sort) => {
    try {
      let formData = new FormData();
      formData.append("type", "sort_by_product");
      ...
      console.error("Error fetching sorted puja data:", error);
    }
  };
  ...
  return (
    <div className=" bg-[#FFEEE2]">
      <div className=" container max-w-7xl  mx-auto  font-sans pt-10 overflow-hidden">
        <div className="p-">
          <div className="items-center gap-12">
            <div>
              <h2 className="lg:text-3xl md:text-2xl text-3xl font-bold mb-4">
              {t("PoojaBoxonLatestAutoTech")}
              </h2>
              ...
              <div className="mt-5 flex gap-4">
                ...
                <form
                  ...
                  className="flex px-4 py-2 w-full rounded-md border-2 border-orange-400 bg-white overflow-hidden font-[sans-serif]"
                >
                  <input
                    type="text"
        ...
        <List pujaData={searchQuery ? pujaData : sortBy ? sortlist : pujaDatalist} />
      </div>
    </div>
  );
}
