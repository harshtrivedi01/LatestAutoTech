...
export default function Footersection() {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
            ...
            <div className="mt-10">
                <h1 className=" font-bold mb-2">M/S Satsambhav Technologies Private Limited</h1>
                ...
                <p className="flex items-center">
					...
					<span>report@punyasetu.com</span>
				</p>
				<p className="flex items-center">
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
	...
	<div className="py-6 text-[16px] border-t border-[#FA8128] text-center dark:text-gray-600">© 2025 Punyasetu , Inc. All rights reserved.</div>
</footer> 
      </>
    )
}