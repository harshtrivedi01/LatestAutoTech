					...
					<div className="grid grid-cols-2 ga lg:w-2/3 lg:grid-cols-3">
						...
						<nav>
							...
							<div className="flex  space-x-1">
								...
								<a  target="_blank" rel="noopener noreferrer" href={pujaData?.social_links.linkedin} title="Twitter" className="flex items-center p-1">
								...
								<a  target="_blank" rel="noopener noreferrer" href={pujaData?.social_links.telegram} title="Twitter" className="flex items-center p-1">
