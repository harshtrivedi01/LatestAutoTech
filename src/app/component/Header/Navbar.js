      ...
      <nav className="bg-white relative dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="/" className="flex items-center space-x-5 rtl:space-x-reverse">
            <img src="https://www.punyasetu.com/assets/images/logo.png" className="h-16 mb-2" alt="PunyaSetu Logo" />
            <span className="self-center text-3xl font-semibold whitespace-nowrap dark:text-white">PunyaSetu</span>
          </a>
                ...
                <div className="relative">
                  ...
                  {showDropdown && (
                    <div className="absolute left-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg">
                      <div className="px-4 py-2 cursor-pointer text-red-600 hover:bg-gray-100 hover:rounded-lg" onClick={handleLogout}>
                        Logout
                      </div>
                    </div>
                  )}
          ...
          {/* Mobile Sidebar */}
          <div className={`absolute top-24 left-0 w-full bg-white md:hidden transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
          ...
          <div className="invisible absolute  z-50 flex w-full flex-col bg-gray-100 py-1 rounded-b-xl px-4 text-gray-800 shadow-xl group-hover:visible">
            ...
            <a className="my-2 block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-black md:mx-2">
              ...
              <li>
                <a href="/" className="block py-2 px-3 text-black hover:bg-gray-100">Home</a>
              </li>
              <li>
                <a href="/about" className="block py-2 px-3 text-black hover:bg-gray-100">About Us</a>
              </li>
              <li>
                <a href="/service" className="block py-2 px-3 text-black hover:bg-gray-100">Service</a>
              </li>
              <li>
                <a href="/contact" className="block py-2 px-3 text-black hover:bg-gray-100">Contact Us</a>
              </li>
              <li>
                <a href="/join" className="block py-2 px-3 text-black hover:bg-gray-100">Join Us</a>
              </li>
          ...
          <div className="hidden md:flex md:items-center md:w-auto md:order-1">
            <ul className="flex flex-row space-x-8 text-lg font-semibold">
              <li>
                <a href="/" className="text-black hover:text-orange-700">Home</a>
              </li>
              <li>
                <a href="/about" className="text-black hover:text-orange-700">About Us</a>
              </li>
              <li>
                <a href="/service" className="text-black hover:text-orange-700">Service</a>
              </li>
              <li>
                <a href="/contact" className="text-black hover:text-orange-700">Contact Us</a>
              </li>
              <li>
                <a href="/join" className="text-black hover:text-orange-700">Join Us</a>
              </li>
              <li>
