...
//           <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
//         </svg>
//         <span className="mr-2  rounded text-yellow-900 px-2.5 py-0.5 text-xs font-semibold">(135)</span>
//       </div>
//     <div className="mt-2 mb-5 flex items-center justify-between">
        
//       <p>
//         <span className="text-3xl font-bold text-slate-900">₹745</span>
//         <span className="text-sm text-slate-900 line-through">M.R.P ₹699  </span> <span className="text-red-700 text-lg ms-3">(50% off)</span>
//       </p>
                    ...
                    <div className="mt-2 mb-5 flex items-center justify-between">
                      <p>
                        <span className="text-3xl font-bold text-slate-900">
                          ₹{puja.discounted_price || '745'}
                        </span>
                        <span className="text-sm text-slate-900 line-through">
                          M.R.P ₹{puja.discounted_price ? '699' : '745'}
                        </span>
