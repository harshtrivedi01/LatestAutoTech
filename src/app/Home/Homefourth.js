  ...
  {puja.stock ? (
    <button
      ...
      className={`flex items-center justify-center rounded-md px-10 shadow-xl py-2 text-center text-sm font-medium text-white
        ${cartStatus[index] ? "bg-orange-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"}
      `}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <span className="flex items-center justify-center rounded-md px-10 shadow-xl py-2 text-center border text-base font-medium text-red-600">Out of Stock</span>
  )}
</div>
