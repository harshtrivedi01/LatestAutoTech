  ...
  const Content = () =>  {
	return (
	  <div className='p-60 bg-grey content'  id="about-section" >
        ...
        <p >
        This powerful Tridev Pooja blesses devotees with financial prosperity,
         stability, and wealth protection. According to scriptures, Maa Lakshmi 
         once sought guidance from Lord Shiva to understand why her devotees often
          lose the wealth granted by her blessings. Lord Shiva explained that while 
          her grace brings prosperity, wealth without protection is quickly lost due 
          to greed, mismanagement, and karmic obstacles. To safeguard wealth, Lord Shiva
           sent Batuk Bhairav, his youthful form, as the protector of the wealth of Maa
            Lakshmi's devotees. Additionally, Lord Kuber, the deity of stable wealth, 
            was invited to provide permanence and security to Maa Lakshmi's prosperity. 
            This is why it is believed that the triad of deities—Maa Lakshmi, Lord Kuber,
             and Batuk Bhairav—offers devotees a complete solution for prosperity, stability,
              and the protection of wealth. To fulfill this purpose, on Friday, a special
               Kuber-Bhairav-Lakshmi Wealth Protection Pooja will be held at the Etteluthu 
               Perumal Temple in Tirunelveli, South India. The ritual includes the chanting 
               of 11,000 Kuber Mantras, Batuk Bhairav Kavach Path, and Shri Sukta Havan. 
               Participate in this special ritual through Sri Mandir and receive divine blessings
