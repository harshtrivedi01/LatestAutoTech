...
//                  hover:bg-green-700 hover:scale-105 transition-transform duration-300 animate-pulse cursor-pointer z-40"
//     >
//        {t("SelectPoojapackage")}
//     </a>     
//       )}
...
// <section id="Poojavideo" className="relative z-10"> <Poojavideo/>  </section>
...
<div className="w-full h-[250px] sm:h-[300px] md:h-[400px] lg:h-[500px] xl:h-[400px]">
  ...
  <div className="container flex justify-center space-x-4 border-b">
    ...
    >
      ...
      {/* Sections */}
      <section id="about-pooja" className="z-10"> <Content detail={pujaData}  /> </section>
